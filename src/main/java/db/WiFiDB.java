...
public class WiFiDB {
	...
	public List<String[]> dbHistorySelect() {
		...
		String url = "jdbc:mariadb://3.39.71.112/freewifi";
	...
	public void dbHistoryInsert(String LAT, String LNT) {
		// mariaDB 연결
		String dbUrl = "jdbc:mariadb://3.39.71.112/freewifi";
		String dbUserId = "wifiuser";
		String dbPassword = "zerobase";
	...
	public List<WiFi> dbSelect(String address) {
...
//				System.out.println(MGR_NO + "," + WRDOFC + "," + MAIN_NM + "," + ADRES1 + "," + ADRES2 + ","
...
//						+ "," + INOUT_DOOR + "," + REMARS3 + "," + LAT + "," + LNT + "," + WORK_DTTM);
	...
	public String[] dbInsert(String startData, String endData) {
		...
		// OpenAPI 인증키
		String key = "474f68495566726f38334c48535250";
		...
		try {
			...
			// TbPublicWifiInfo >> 1. list_total_count 2. RESULT 3. row
